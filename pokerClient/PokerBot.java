...
public class PokerBot{
	private static final String fileLocation = "C:\\Users\\Eric\\Dropbox\\Java Projects\\CardApplications\\doc\\playerPlayers.txt";
		...
		while(gameOn){
			...
			for(int i = 0; i < table.size(); i++){
				if(i != table.size() - 1 && table.get(i).getInPlay()){
					...
					System.out.println(table.get(i).getHand().get(0).getCardName());
					System.out.println(table.get(i).getHand().get(1).getCardName());
	...
	public static void humanChoice(Human player, int index){
		...
		System.out.println(player.getHand().get(0).getCardName());
		System.out.println(player.getHand().get(1).getCardName());
	...
	public static void printCommunityCards(){
		...
		for(int i = 0; i < communityCards.size(); i++){
			System.out.println(communityCards.get(i).getCardName());
		}
		System.out.println();
	}//printCommunityCards()
