...
public class Computer extends Player{
	...
	public double[] getPreFlopDecision(int BBposition, int myPosition, double currentBetSize, double BBsize, ArrayList<Player> table){
		...
		System.out.println("(" + hand.get(0).getCardName() + ", " + hand.get(1).getCardName() + ")");
	...
	/**
	 * This method is intended to take a two-card hand and return a value from 1-7 that denotes the strength of that hand in the game of Texas Hold Em.
	 * @param hand
	 * @return hand strength
	 */
	public static int getStartingHandStrength(ArrayList<Card> hand){
		Card card1 = hand.get(0), card2 = hand.get(1);
		int value1 = card1.getCardValue(), value2 = card2.getCardValue();
		int  highCard, lowCard;
		...
		if(value1 == value2){	
			suited = false;
			if(value1 >= 10){																	//Pair of Aces, Kings, Queens
				return 7;
			}else if(value1 >= 8){																//Pair of Jacks, 10
				return 6;
			}else if(value1 >= 4){																//Mid-Value Pairs: 9, 8, 7, 6
				return 5;
			}else{																				//Low Pairs: 5, 4, 3, 2
				return 4;
			}
		}else{
			...
			if(highCard < 12 && lowCard < 6 && !suited){										//High less than Ace, low less than 8, offsuit
				return 1;
			}else if(highCard == 12 && lowCard < 7 && !suited){									//High is Ace, low less than 9, offsuit
				return 2;
			}else if(highCard > 6 && lowCard == 6 && !suited){									//High more than 8, low is 8, offsuit
				return 2;
			}else if(highCard == 8 && lowCard < 4 && suited){									//High is 10, low less than 6, suited
				return 2;
			}else if(highCard < 8 && highCard > 5 && lowCard < 3 && suited){					//High is 8 or 9, low less than 5, suited
				return 2;
			}else if(highCard == 5 && lowCard < 2 && suited){									//High is 7, low less than 4, suited
				return 2;
			}else if(highCard < 5 && lowCard == 0 && suited){									//High less than 7, low is 2, suited
				return 2;
			}else if(highCard > 8 && lowCard == 7 && !suited){									//High more than 10, low is 7, offsuit
				return 3;
			}else if(highCard < 12 && highCard > 8 && lowCard < 6 && suited){					//High is from Jack to King, low less than 8, suited
				return 3;
			}else if(highCard < 11 && lowCard > 3 && lowCard < 6 && suited){					//High less than Ace, low is 6 or 7, suited
				return 3;
			}else if(highCard < 8 && lowCard == 3 && suited){									//High less than 10, low is 5, suited
				return 3;
			}else if(highCard < 6 && lowCard == 2 && suited){									//High less than 8, low is 4, suited
				return 3;
			}else if(highCard < 5 && lowCard == 1 && suited){									//High less than 7, low is 3, suited
				return 3;
			}else if(highCard < 12 && lowCard == 10 && !suited){								//High less than Ace, low is 10, offsuit
				return 4;
			}else if(highCard > 9 && lowCard > 7 && lowCard < 11 && !suited){					//High more than Jack, low from 10 to Queen, offsuit
				return 5;
			}else if(lowCard < 8 && lowCard > 5 && suited){										//Low is 8 or 9, suited
				return 5;
			}else if(highCard == 12 && lowCard < 8 && suited){									//High is Ace, low less than 10, suited
				return 5;
			}else if(lowCard < 11 && lowCard > 7 && suited){									//Low is from 10 to Queen, suited
				return 6;
			}else if(highCard == 12 && lowCard == 11 && !suited){								//Ace-King offsuit
				return 6;
			}else{
				return 7;
			}
